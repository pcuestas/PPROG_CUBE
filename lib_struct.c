...
/*
    auxiliary matrix, for the internal cube, this is the same thing as cube[56][3] 
...
void paint_sStickerLines(sSticker *s, float cube[56][3], double **rgb){
    /*lines*/
    glColor3f(0, 0, 0);
...
void paint_sSticker(sSticker *s, float cube[56][3], double **rgb)
{
    ...
    /*paint the lines*/
    paint_sStickerLines(s, cube, rgb);
